...
export class AccountClient {
    ...
    registerStudy(courseId: number | undefined): Promise<RegisterStudyMapping> {
        let url_ = this.baseUrl + "/api/Account/RegisterStudy?";
        if (courseId === null)
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processRegisterStudy(_response);
        });
    }

    protected processRegisterStudy(response: Response): Promise<RegisterStudyMapping> {
        followIfLoginRedirect(response);
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
    ...
    changePassword(currentPassword: string | undefined, newPassword: string | undefined): Promise<Result> {
    ...
    protected processChangePassword(response: Response): Promise<Result> {
        followIfLoginRedirect(response);
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
...
export class AnswersClient {
    ...
    getEntities(questionId: number | null | undefined, filters: string | null | undefined, sorts: string | null | undefined, page: number | null | undefined, pageSize: number | null | undefined): Promise<PagingModelOfAnswersMapping> {
    ...
    protected processGetEntities(response: Response): Promise<PagingModelOfAnswersMapping> {
        followIfLoginRedirect(response);
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = PagingModelOfAnswersMapping.fromJS(resultData200);
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<PagingModelOfAnswersMapping>(null as any);
    }

    createEntity(entity: AnswersCreate): Promise<Result> {
        let url_ = this.baseUrl + "/api/Answers";
        url_ = url_.replace(/[?&]$/, "");
    ...
    getEntity(id: number): Promise<AnswersMapping> {
    ...
    protected processGetEntity(response: Response): Promise<AnswersMapping> {
        followIfLoginRedirect(response);
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = AnswersMapping.fromJS(resultData200);
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<AnswersMapping>(null as any);
    }

    updateEntity(id: number, entity: AnswersUpdate): Promise<Result> {
        let url_ = this.baseUrl + "/api/Answers/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
...
export class AuthClient {
    ...
    register(request: RegisterRequest): Promise<Result> {
    ...
    refreshAccessToken(refreshToken: string | undefined): Promise<TokenRequest> {
    ...
    protected processRefreshAccessToken(response: Response): Promise<TokenRequest> {
        followIfLoginRedirect(response);
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
...
export class BillClient {
    ...
    createEntity(entity: BillCreate): Promise<Result> {
    ...
    getEntities(filters: string | null | undefined, sorts: string | null | undefined, page: number | null | undefined, pageSize: number | null | undefined): Promise<PagingModelOfBillMapping> {
        let url_ = this.baseUrl + "/api/Bill?";
        if (filters !== undefined && filters !== null)
            url_ += "Filters=" + encodeURIComponent("" + filters) + "&";
        if (sorts !== undefined && sorts !== null)
    ...
    protected processGetEntities(response: Response): Promise<PagingModelOfBillMapping> {
        followIfLoginRedirect(response);
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = PagingModelOfBillMapping.fromJS(resultData200);
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<PagingModelOfBillMapping>(null as any);
    }

    getEntity(id: number): Promise<BillMapping> {
        let url_ = this.baseUrl + "/api/Bill/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetEntity(response: Response): Promise<BillMapping> {
        followIfLoginRedirect(response);
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = BillMapping.fromJS(resultData200);
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<BillMapping>(null as any);
    }

    updateEntity(id: number, entity: BillUpdate): Promise<Result> {
        let url_ = this.baseUrl + "/api/Bill/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
...
export class BillStatusClient {
    ...
    getEntities(filters: string | null | undefined, sorts: string | null | undefined, page: number | null | undefined, pageSize: number | null | undefined): Promise<PagingModelOfBillStatusMapping> {
        let url_ = this.baseUrl + "/api/BillStatus?";
        if (filters !== undefined && filters !== null)
            url_ += "Filters=" + encodeURIComponent("" + filters) + "&";
        if (sorts !== undefined && sorts !== null)
            url_ += "Sorts=" + encodeURIComponent("" + sorts) + "&";
    ...
    protected processGetEntities(response: Response): Promise<PagingModelOfBillStatusMapping> {
        followIfLoginRedirect(response);
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = PagingModelOfBillStatusMapping.fromJS(resultData200);
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<PagingModelOfBillStatusMapping>(null as any);
    }

    createEntity(entity: BillStatusCreate): Promise<Result> {
        let url_ = this.baseUrl + "/api/BillStatus";
        url_ = url_.replace(/[?&]$/, "");
    ...
    getEntity(id: number): Promise<BillStatusMapping> {
        let url_ = this.baseUrl + "/api/BillStatus/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetEntity(response: Response): Promise<BillStatusMapping> {
        followIfLoginRedirect(response);
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = BillStatusMapping.fromJS(resultData200);
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<BillStatusMapping>(null as any);
    }

    updateEntity(id: number, entity: BillStatusUpdate): Promise<Result> {
        let url_ = this.baseUrl + "/api/BillStatus/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
...
export class CourseSubjectClient {
    private http: { fetch(url: RequestInfo, init?: RequestInit): Promise<Response> };
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    getEntities(courseId: number | null | undefined, filters: string | null | undefined, sorts: string | null | undefined, page: number | null | undefined, pageSize: number | null | undefined): Promise<PagingModelOfCourseSubjectMapping> {
        let url_ = this.baseUrl + "/api/CourseSubject?";
    ...
    protected processGetEntities(response: Response): Promise<PagingModelOfCourseSubjectMapping> {
        followIfLoginRedirect(response);
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = PagingModelOfCourseSubjectMapping.fromJS(resultData200);
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<PagingModelOfCourseSubjectMapping>(null as any);
    }

    createEntity(entity: CourseSubjectCreate): Promise<Result> {
        let url_ = this.baseUrl + "/api/CourseSubject";
        url_ = url_.replace(/[?&]$/, "");
    ...
    getEntity(id: number): Promise<CourseSubjectMapping> {
        let url_ = this.baseUrl + "/api/CourseSubject/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetEntity(response: Response): Promise<CourseSubjectMapping> {
        followIfLoginRedirect(response);
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = CourseSubjectMapping.fromJS(resultData200);
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<CourseSubjectMapping>(null as any);
    }

    updateEntity(id: number, entity: CourseSubjectUpdate): Promise<Result> {
        let url_ = this.baseUrl + "/api/CourseSubject/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
...
export class LearningProgressClient {
    ...
    getEntities(registerStudyId: number | null | undefined, filters: string | null | undefined, sorts: string | null | undefined, page: number | null | undefined, pageSize: number | null | undefined): Promise<PagingModelOfLearningProgressMapping> {
        let url_ = this.baseUrl + "/api/LearningProgress?";
        if (registerStudyId !== undefined && registerStudyId !== null)
            url_ += "RegisterStudyId=" + encodeURIComponent("" + registerStudyId) + "&";
        if (filters !== undefined && filters !== null)
            url_ += "Filters=" + encodeURIComponent("" + filters) + "&";
        if (sorts !== undefined && sorts !== null)
            url_ += "Sorts=" + encodeURIComponent("" + sorts) + "&";
    ...
    protected processGetEntities(response: Response): Promise<PagingModelOfLearningProgressMapping> {
        followIfLoginRedirect(response);
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = PagingModelOfLearningProgressMapping.fromJS(resultData200);
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<PagingModelOfLearningProgressMapping>(null as any);
    }

    createEntity(entity: LearningProgressCreate): Promise<Result> {
        let url_ = this.baseUrl + "/api/LearningProgress";
        url_ = url_.replace(/[?&]$/, "");
    ...
    getEntity(id: number): Promise<LearningProgressMapping> {
        let url_ = this.baseUrl + "/api/LearningProgress/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetEntity(response: Response): Promise<LearningProgressMapping> {
        followIfLoginRedirect(response);
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = LearningProgressMapping.fromJS(resultData200);
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<LearningProgressMapping>(null as any);
    }

    updateEntity(id: number, entity: LearningProgressUpdate): Promise<Result> {
        let url_ = this.baseUrl + "/api/LearningProgress/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
...
export class MakeQuestionClient {
    private http: { fetch(url: RequestInfo, init?: RequestInit): Promise<Response> };
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    getEntities(subjectDetailId: number | null | undefined, filters: string | null | undefined, sorts: string | null | undefined, page: number | null | undefined, pageSize: number | null | undefined): Promise<PagingModelOfMakeQuestionMapping> {
        let url_ = this.baseUrl + "/api/MakeQuestion?";
    ...
    protected processGetEntities(response: Response): Promise<PagingModelOfMakeQuestionMapping> {
        followIfLoginRedirect(response);
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = PagingModelOfMakeQuestionMapping.fromJS(resultData200);
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<PagingModelOfMakeQuestionMapping>(null as any);
    }

    createEntity(entity: MakeQuestionCreate): Promise<Result> {
        let url_ = this.baseUrl + "/api/MakeQuestion";
        url_ = url_.replace(/[?&]$/, "");
    ...
    getEntity(id: number): Promise<MakeQuestionMapping> {
        let url_ = this.baseUrl + "/api/MakeQuestion/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetEntity(response: Response): Promise<MakeQuestionMapping> {
        followIfLoginRedirect(response);
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = MakeQuestionMapping.fromJS(resultData200);
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<MakeQuestionMapping>(null as any);
    }

    updateEntity(id: number, entity: MakeQuestionUpdate): Promise<Result> {
        let url_ = this.baseUrl + "/api/MakeQuestion/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
...
export class StatisticalClient {
    ...
    getTotalRevenue(startDate: Date | null | undefined, endDate: Date | null | undefined): Promise<FileResponse> {
        let url_ = this.baseUrl + "/api/Statistical/total-revenue?";
    ...
    protected processGetTotalRevenue(response: Response): Promise<FileResponse> {
        followIfLoginRedirect(response);
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200 || status === 206) {
    ...
    getTopSellingCourses(startDate: Date | null | undefined, endDate: Date | null | undefined, topN: number | undefined): Promise<FileResponse> {
        let url_ = this.baseUrl + "/api/Statistical/top-selling-courses?";
        if (startDate !== undefined && startDate !== null)
            url_ += "startDate=" + encodeURIComponent(startDate ? "" + startDate.toISOString() : "") + "&";
        if (endDate !== undefined && endDate !== null)
            url_ += "endDate=" + encodeURIComponent(endDate ? "" + endDate.toISOString() : "") + "&";
        if (topN === null)
            throw new Error("The parameter 'topN' cannot be null.");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetTopSellingCourses(_response);
        });
    }

    protected processGetTopSellingCourses(response: Response): Promise<FileResponse> {
        followIfLoginRedirect(response);
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200 || status === 206) {
...
export class CertificateMapping implements ICertificateMapping {
    ...
    description?: string;
    image?: string;
    certificateType?: CertificateTypeMapping;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.certificateType = _data["certificateType"] ? CertificateTypeMapping.fromJS(_data["certificateType"]) : <any>undefined;
        }
    }
...
export class PagingModelOfAnswersMapping implements IPagingModelOfAnswersMapping {
    ...
    constructor(data?: IPagingModelOfAnswersMapping) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (_data) {
            if (Array.isArray(_data["items"])) {
                ...
                for (let item of _data["items"])
                    this.items!.push(AnswersMapping.fromJS(item));
            }
    ...
    static fromJS(data: any): PagingModelOfAnswersMapping {
        data = typeof data === 'object' ? data : {};
        let result = new PagingModelOfAnswersMapping();
        result.init(data);
        return result;
    }
...
export interface IPagingModelOfAnswersMapping {
    items?: AnswersMapping[];
    pageNumber?: number;
    totalPages?: number;
    totalCount?: number;
...
export class AnswersMapping implements IAnswersMapping {
    id?: number;
    questionId?: number;
    userId?: number;
    answer?: string;
    ...
    static fromJS(data: any): AnswersMapping {
        data = typeof data === 'object' ? data : {};
        let result = new AnswersMapping();
        result.init(data);
        return result;
    }
...
export interface IAnswersMapping {
    id?: number;
    questionId?: number;
    userId?: number;
    answer?: string;
...
export class AnswersCreate implements IAnswersCreate {
    ...
    constructor(data?: IAnswersCreate) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): AnswersCreate {
        data = typeof data === 'object' ? data : {};
        let result = new AnswersCreate();
        result.init(data);
        return result;
    }
...
export class AnswersUpdate implements IAnswersUpdate {
    id?: number;
    questionId?: number;
    userId?: number;
    answer?: string;
    ...
    constructor(data?: IAnswersUpdate) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): AnswersUpdate {
        data = typeof data === 'object' ? data : {};
        let result = new AnswersUpdate();
        result.init(data);
        return result;
    }
...
export interface IAnswersUpdate {
    id?: number;
    questionId?: number;
    userId?: number;
    answer?: string;
...
export class BillCreate implements IBillCreate {
    userId?: number;
    courseId?: number;
    price?: number;
    billStatusId?: number;
    vnPaySettings?: VNPaySettings | undefined;

    constructor(data?: IBillCreate) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.price = _data["price"];
            this.billStatusId = _data["billStatusId"];
            this.vnPaySettings = _data["vnPaySettings"] ? VNPaySettings.fromJS(_data["vnPaySettings"]) : <any>undefined;
        }
    }

    static fromJS(data: any): BillCreate {
        data = typeof data === 'object' ? data : {};
        let result = new BillCreate();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["price"] = this.price;
        data["billStatusId"] = this.billStatusId;
        data["vnPaySettings"] = this.vnPaySettings ? this.vnPaySettings.toJSON() : <any>undefined;
        return data;
    }
}
...
export class VNPaySettings implements IVNPaySettings {

    constructor(data?: IVNPaySettings) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): VNPaySettings {
        data = typeof data === 'object' ? data : {};
        let result = new VNPaySettings();
        result.init(data);
        return result;
    }
...
export interface IVNPaySettings {
}

export class PagingModelOfBillMapping implements IPagingModelOfBillMapping {
    items?: BillMapping[];
    pageNumber?: number;
    totalPages?: number;
    totalCount?: number;
    ...
    constructor(data?: IPagingModelOfBillMapping) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items!.push(BillMapping.fromJS(item));
            }
            this.pageNumber = _data["pageNumber"];
            this.totalPages = _data["totalPages"];
            this.totalCount = _data["totalCount"];
    ...
    static fromJS(data: any): PagingModelOfBillMapping {
        data = typeof data === 'object' ? data : {};
        let result = new PagingModelOfBillMapping();
        result.init(data);
        return result;
    }
...
export interface IPagingModelOfBillMapping {
    items?: BillMapping[];
    pageNumber?: number;
    totalPages?: number;
    totalCount?: number;
...
export class BillUpdate implements IBillUpdate {
    ...
    static fromJS(data: any): BillUpdate {
        data = typeof data === 'object' ? data : {};
        let result = new BillUpdate();
        result.init(data);
        return result;
    }
...
export class PagingModelOfBillStatusMapping implements IPagingModelOfBillStatusMapping {
    items?: BillStatusMapping[];
    pageNumber?: number;
    totalPages?: number;
    totalCount?: number;
    pageSize?: number;
    ...
    constructor(data?: IPagingModelOfBillStatusMapping) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items!.push(BillStatusMapping.fromJS(item));
            }
            this.pageNumber = _data["pageNumber"];
            this.totalPages = _data["totalPages"];
            this.totalCount = _data["totalCount"];
    ...
    static fromJS(data: any): PagingModelOfBillStatusMapping {
        data = typeof data === 'object' ? data : {};
        let result = new PagingModelOfBillStatusMapping();
        result.init(data);
        return result;
    }
...
export interface IPagingModelOfBillStatusMapping {
    items?: BillStatusMapping[];
    pageNumber?: number;
    totalPages?: number;
    totalCount?: number;
...
export class BillStatusCreate implements IBillStatusCreate {
    name?: string;

    constructor(data?: IBillStatusCreate) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): BillStatusCreate {
        data = typeof data === 'object' ? data : {};
        let result = new BillStatusCreate();
        result.init(data);
        return result;
    }
...
export interface IBillStatusCreate {
    name?: string;
}

export class BillStatusUpdate implements IBillStatusUpdate {
    id?: number;
    name?: string;

    constructor(data?: IBillStatusUpdate) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): BillStatusUpdate {
        data = typeof data === 'object' ? data : {};
        let result = new BillStatusUpdate();
        result.init(data);
        return result;
    }
...
export class CommentBlogMapping implements ICommentBlogMapping {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.content = _data["content"];
            this.edited = _data["edited"];
            this.blog = _data["blog"] ? BlogMapping.fromJS(_data["blog"]) : <any>undefined;
            this.user = _data["user"] ? UserMapping.fromJS(_data["user"]) : <any>undefined;
            this.parent = _data["parent"] ? CommentBlogMapping.fromJS(_data["parent"]) : <any>undefined;
        }
    }
...
export class PagingModelOfCourseSubjectMapping implements IPagingModelOfCourseSubjectMapping {
    items?: CourseSubjectMapping[];
    pageNumber?: number;
    totalPages?: number;
    totalCount?: number;
    pageSize?: number;
    ...
    constructor(data?: IPagingModelOfCourseSubjectMapping) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items!.push(CourseSubjectMapping.fromJS(item));
            }
            this.pageNumber = _data["pageNumber"];
            this.totalPages = _data["totalPages"];
            this.totalCount = _data["totalCount"];
    ...
    static fromJS(data: any): PagingModelOfCourseSubjectMapping {
        data = typeof data === 'object' ? data : {};
        let result = new PagingModelOfCourseSubjectMapping();
        result.init(data);
        return result;
    }
...
export interface IPagingModelOfCourseSubjectMapping {
    items?: CourseSubjectMapping[];
    pageNumber?: number;
    totalPages?: number;
    totalCount?: number;
...
export class CourseSubjectCreate implements ICourseSubjectCreate {
    courseId?: number;
    subjectId?: number;

    constructor(data?: ICourseSubjectCreate) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CourseSubjectCreate {
        data = typeof data === 'object' ? data : {};
        let result = new CourseSubjectCreate();
        result.init(data);
        return result;
    }
...
export interface ICourseSubjectCreate {
    courseId?: number;
    subjectId?: number;
}

export class CourseSubjectUpdate implements ICourseSubjectUpdate {
    id?: number;
    courseId?: number;
    subjectId?: number;

    constructor(data?: ICourseSubjectUpdate) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CourseSubjectUpdate {
        data = typeof data === 'object' ? data : {};
        let result = new CourseSubjectUpdate();
        result.init(data);
        return result;
    }
...
export interface ICourseSubjectUpdate {
    id?: number;
    courseId?: number;
    subjectId?: number;
}
...
export class PagingModelOfLearningProgressMapping implements IPagingModelOfLearningProgressMapping {
    ...
    constructor(data?: IPagingModelOfLearningProgressMapping) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items!.push(LearningProgressMapping.fromJS(item));
            }
            this.pageNumber = _data["pageNumber"];
            this.totalPages = _data["totalPages"];
            this.totalCount = _data["totalCount"];
    ...
    static fromJS(data: any): PagingModelOfLearningProgressMapping {
        data = typeof data === 'object' ? data : {};
        let result = new PagingModelOfLearningProgressMapping();
        result.init(data);
        return result;
    }
...
export interface IPagingModelOfLearningProgressMapping {
    items?: LearningProgressMapping[];
    pageNumber?: number;
    totalPages?: number;
    totalCount?: number;
...
export class LearningProgressCreate implements ILearningProgressCreate {
    ...
    constructor(data?: ILearningProgressCreate) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): LearningProgressCreate {
        data = typeof data === 'object' ? data : {};
        let result = new LearningProgressCreate();
        result.init(data);
        return result;
    }
...
export class LearningProgressUpdate implements ILearningProgressUpdate {
    id?: number;
    userId?: number;
    registerStudyId?: number;
    currentSubjectId?: number;

    constructor(data?: ILearningProgressUpdate) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): LearningProgressUpdate {
        data = typeof data === 'object' ? data : {};
        let result = new LearningProgressUpdate();
        result.init(data);
        return result;
    }
...
export interface ILearningProgressUpdate {
    id?: number;
    userId?: number;
    registerStudyId?: number;
    currentSubjectId?: number;
...
export class PagingModelOfMakeQuestionMapping implements IPagingModelOfMakeQuestionMapping {
    items?: MakeQuestionMapping[];
    pageNumber?: number;
    totalPages?: number;
    totalCount?: number;
    pageSize?: number;
    ...
    constructor(data?: IPagingModelOfMakeQuestionMapping) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items!.push(MakeQuestionMapping.fromJS(item));
            }
            this.pageNumber = _data["pageNumber"];
            this.totalPages = _data["totalPages"];
            this.totalCount = _data["totalCount"];
    ...
    static fromJS(data: any): PagingModelOfMakeQuestionMapping {
        data = typeof data === 'object' ? data : {};
        let result = new PagingModelOfMakeQuestionMapping();
        result.init(data);
        return result;
    }
...
export interface IPagingModelOfMakeQuestionMapping {
    items?: MakeQuestionMapping[];
    pageNumber?: number;
    totalPages?: number;
    totalCount?: number;
...
export class MakeQuestionCreate implements IMakeQuestionCreate {
    ...
    constructor(data?: IMakeQuestionCreate) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): MakeQuestionCreate {
        data = typeof data === 'object' ? data : {};
        let result = new MakeQuestionCreate();
        result.init(data);
        return result;
    }
...
export interface IMakeQuestionCreate {
    subjectDetailId?: number;
    question?: string;
}

export class MakeQuestionUpdate implements IMakeQuestionUpdate {
    id?: number;
    subjectDetailId?: number;
    question?: string;

    constructor(data?: IMakeQuestionUpdate) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): MakeQuestionUpdate {
        data = typeof data === 'object' ? data : {};
        let result = new MakeQuestionUpdate();
        result.init(data);
        return result;
    }
...
export interface IMakeQuestionUpdate {
    id?: number;
    subjectDetailId?: number;
    question?: string;
}
